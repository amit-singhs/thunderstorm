...
// Function to create and configure Fastify instance
      ...
      try {
        ...
        if (existingData.verified) {
          return reply
            ...
            .send({
              error:
                "Email is already verified, please proceed to use the app.",
            });
        }
...
export default async function handler(req: FastifyRequest, res: FastifyReply) {
  const app = await createApp(); // Initialize the Fastify app
